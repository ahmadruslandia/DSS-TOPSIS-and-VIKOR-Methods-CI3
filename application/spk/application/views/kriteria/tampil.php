<div class="panel panel-default">
    <div class="panel-heading">
        <form class="form-inline">
            ...
            <div class="form-group">
                <a class="btn btn-default <?= ($this->session->userdata('level') == 'admin') ? '' : 'hidden' ?>" target="_blank" href="<?= site_url('kriteria/cetak?search=' . $this->input->get('search')) ?>"><span class="glyphicon glyphicon-print"></span> Cetak</a>
            </div>
        </form>
    </div>
